...
LOCAL_SOURCE_ACCESS_ROOT = Path(os.getenv("REASONKB_LOCAL_SOURCE_ACCESS_ROOT", PROJECTS_ROOT))
MASTER_KEY_PATH = Path(os.getenv("REASONKB_MASTER_KEY_FILE", "/run/secrets/reasonkb_master_key"))
...
SOURCE_WORKER_POLL_SECONDS = float(os.getenv("SOURCE_WORKER_POLL_SECONDS", "1"))
