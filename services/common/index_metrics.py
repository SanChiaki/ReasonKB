...
class IndexRunMetrics:
    ...
    _all_provider_reasoning_usage: bool = True
    ...
    def record_llm_call(
        ...
        *,
        ...
        if reasoning_tokens is None:
            self._all_provider_reasoning_usage = False
            self.reasoning_tokens = None
        elif self._all_provider_reasoning_usage:
            self.reasoning_tokens = (self.reasoning_tokens or 0) + max(
                reasoning_tokens, 0
            )
