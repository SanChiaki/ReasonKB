...
const messages = {
  en: {
    ...
    "projects.createPlaceholder": "Enter project name",
    "projects.create": "Create Project",
    "projects.creating": "Creating...",
    "projects.createError": "Unable to create project. Please try again.",
    ...
    "projects.emptyDescription": "Create a new project to start organizing PDFs for chat.",
    ...
    "projects.renameError": "Unable to rename project. Please try again.",
    ...
    "documents.noneSelected": "No files selected",
    "documents.filesSelected": "{count} file{plural} selected",
    "documents.uploadFiles": "Upload files",
    "documents.uploading": "Uploading...",
    "documents.uploadError": "Upload failed. Try again.",
    "documents.uploadSummary": "{uploaded} uploaded, {failed} failed",
    ...
    "documents.uploadTime": "Upload Time",
  ...
  zh: {
    ...
    "projects.title": "项目",
    "projects.description": "按项目组织文档，然后全局搜索或在对话中按项目过滤。",
    "projects.search": "搜索项目",
    "projects.createPlaceholder": "输入项目名称",
    "projects.create": "创建项目",
    "projects.creating": "创建中...",
    "projects.createError": "无法创建项目，请重试。",
    "projects.noMatchesTitle": "没有匹配的项目",
    "projects.noMatchesDescription": "没有项目匹配“{query}”。请尝试其他搜索。",
    "projects.emptyTitle": "还没有项目",
    "projects.emptyDescription": "创建一个新项目，开始为对话整理 PDF。",
    ...
    "projects.rename": "重命名",
    "projects.renameError": "无法重命名项目，请重试。",

    "projectDetail.description": "上传 PDF，并在对话使用前检查该项目的索引状态。",
    "projectDetail.searchDocuments": "搜索文档",

    "documents.upload": "上传",
    "documents.uploadTitle": "上传文档",
    "documents.uploadDescription": "选择 PDF、Word、Excel 或 PowerPoint 文件开始索引。",
    "documents.chooseFiles": "选择文件",
    "documents.noneSelected": "未选择文件",
    "documents.filesSelected": "已选择 {count} 个文件",
    "documents.uploadFiles": "上传文件",
    "documents.uploading": "上传中...",
    "documents.uploadError": "上传失败，请重试。",
    "documents.uploadSummary": "已上传 {uploaded} 个，失败 {failed} 个",
