...
const messages = {
  en: {
    ...
    "settings.serviceRefresh": "Refresh service status",
    "settings.serviceLoadError": "Unable to read service status.",
    "settings.serviceChecking": "Checking",
    "settings.serviceHealthy": "Healthy",
    "settings.serviceUnavailable": "Unavailable",
    "settings.serviceUnknown": "Unknown",
    "settings.serviceWeb": "Web",
    "settings.serviceRetrieval": "Retrieval API",
    "settings.serviceMcp": "MCP server",
    "settings.serviceIndexWorker": "Index worker",
    "settings.serviceSourceWorker": "Source worker",
    "settings.serviceGotenberg": "Office conversion",
    "settings.serviceHeartbeatMissing": "No heartbeat received",
    "settings.serviceHeartbeatStale": "Heartbeat timed out",
    "settings.serviceHeartbeatUnreadable": "Heartbeat unavailable",
    "settings.serviceConnectionFailed": "Connection failed",
    "settings.serviceHeartbeatAt": "Heartbeat {time}",
    "settings.serviceLatency": "{latency} ms",
    "settings.modelProviderHealthEyebrow": "Model provider",
    "settings.modelProviderHealth": "Model provider health",
    "settings.modelProviderCheckedAt": "Updated at {time}",
    "settings.modelProviderRefresh": "Refresh model provider status",
    "settings.modelProviderLoadError": "Unable to read model provider status.",
    "settings.modelProviderNoData": "No model calls have been recorded.",
    "settings.modelProviderHealthy": "Healthy",
    "settings.modelProviderDegraded": "Degraded",
    "settings.modelProviderUnavailable": "Unavailable",
    "settings.modelProviderUnknown": "Unknown",
    "settings.modelProviderRecentFailures": "Failures in 5 minutes",
    "settings.modelProviderConsecutiveFailures": "Consecutive failures",
    "settings.modelProviderLastSuccess": "Last success",
    "settings.modelProviderLastFailure": "Last failure",
    "settings.modelProviderRecentErrors": "Recent provider errors",
    "settings.modelOperationIndex": "Index",
    "settings.modelOperationRetrieval": "Retrieval",
    "settings.modelOperationAnswer": "Answer",
    "settings.modelOperationHealthTest": "Connectivity test",
    "settings.modelOperationUnknown": "Model call",
    "settings.modelErrorAuthentication": "Authentication failed",
    "settings.modelErrorConnection": "Connection failed",
    "settings.modelErrorTimeout": "Request timed out",
    "settings.modelErrorRateLimited": "Rate limit reached",
    "settings.modelErrorProviderUnavailable": "Provider unavailable",
    "settings.modelErrorModelNotFound": "Model not found",
    "settings.modelErrorInvalidRequest": "Invalid request",
    "settings.modelErrorProvider": "Provider error",
    ...
    "settings.embeddingEyebrow": "Semantic routing",
    "settings.embeddingTitle": "Embedding model",
    "settings.embeddingEnabled": "Enable semantic routing",
    "settings.embeddingInheritApiKey": "Use the model service API key",
    "settings.embeddingInheritBaseUrl": "Use the model service Base URL",
    ...
    "settings.embeddingInherited": "Inherited from model service",
    "settings.embeddingTest": "Test",
    "settings.embeddingTesting": "Testing...",
    "settings.embeddingSave": "Save embedding settings",
    "settings.embeddingSaving": "Saving...",
    "settings.embeddingSaved": "Embedding settings saved.",
    "settings.embeddingSaveError": "Unable to save embedding settings.",
    "settings.embeddingTestError": "Unable to test the embedding model.",
    "settings.embeddingDimensions": "dimensions",
    "settings.embeddingTokens": "tokens",
    "settings.semanticCoverage": "Index coverage",
    "settings.semanticActiveModel": "Active model",
    "settings.refreshSemanticStatus": "Refresh semantic index status",
    "settings.semanticStatus.unconfigured": "Not configured",
    "settings.semanticStatus.validating": "Validating",
    "settings.semanticStatus.backfilling": "Backfilling",
    "settings.semanticStatus.ready": "Ready",
    "settings.semanticStatus.degraded": "Degraded",
  ...
  zh: {
    ...
    "settings.serviceRefresh": "刷新服务状态",
    "settings.serviceLoadError": "无法读取服务状态。",
    "settings.serviceChecking": "检查中",
    "settings.serviceHealthy": "正常",
    "settings.serviceUnavailable": "不可用",
    "settings.serviceUnknown": "未知",
    "settings.serviceWeb": "Web",
    "settings.serviceRetrieval": "检索 API",
    "settings.serviceMcp": "MCP 服务",
    "settings.serviceIndexWorker": "索引 Worker",
    "settings.serviceSourceWorker": "源同步 Worker",
    "settings.serviceGotenberg": "Office 转换",
    "settings.serviceHeartbeatMissing": "尚未收到心跳",
    "settings.serviceHeartbeatStale": "心跳已超时",
    "settings.serviceHeartbeatUnreadable": "心跳不可读取",
    "settings.serviceConnectionFailed": "连接失败",
    "settings.serviceHeartbeatAt": "心跳 {time}",
    "settings.serviceLatency": "{latency} ms",
    "settings.modelProviderHealthEyebrow": "模型供应商",
    "settings.modelProviderHealth": "模型供应商健康",
    "settings.modelProviderCheckedAt": "更新时间 {time}",
    "settings.modelProviderRefresh": "刷新模型供应商状态",
    "settings.modelProviderLoadError": "无法读取模型供应商状态。",
    "settings.modelProviderNoData": "尚未记录模型调用。",
    "settings.modelProviderHealthy": "正常",
    "settings.modelProviderDegraded": "降级",
    "settings.modelProviderUnavailable": "不可用",
    "settings.modelProviderUnknown": "未知",
    "settings.modelProviderRecentFailures": "近 5 分钟失败",
    "settings.modelProviderConsecutiveFailures": "连续失败",
    "settings.modelProviderLastSuccess": "最近成功",
    "settings.modelProviderLastFailure": "最近失败",
    "settings.modelProviderRecentErrors": "最近供应商异常",
    "settings.modelOperationIndex": "索引",
    "settings.modelOperationRetrieval": "检索",
    "settings.modelOperationAnswer": "回答",
    "settings.modelOperationHealthTest": "连通性测试",
    "settings.modelOperationUnknown": "模型调用",
    "settings.modelErrorAuthentication": "认证失败",
    "settings.modelErrorConnection": "连接失败",
    "settings.modelErrorTimeout": "请求超时",
    "settings.modelErrorRateLimited": "触发限流",
    "settings.modelErrorProviderUnavailable": "供应商不可用",
    "settings.modelErrorModelNotFound": "模型不存在",
    "settings.modelErrorInvalidRequest": "请求无效",
    "settings.modelErrorProvider": "供应商错误",
    ...
    "settings.embeddingEyebrow": "语义路由",
    "settings.embeddingTitle": "Embedding 模型",
    "settings.embeddingEnabled": "启用语义路由",
    "settings.embeddingInheritApiKey": "继承模型服务 API Key",
    "settings.embeddingInheritBaseUrl": "继承模型服务 Base URL",
    "settings.embeddingApiKey": "Embedding API Key",
    "settings.embeddingBaseUrl": "Embedding Base URL",
    "settings.embeddingModel": "Embedding 模型",
    "settings.embeddingInherited": "继承自模型服务",
    "settings.embeddingTest": "测试",
    "settings.embeddingTesting": "测试中...",
    "settings.embeddingSave": "保存 Embedding 设置",
    "settings.embeddingSaving": "保存中...",
    "settings.embeddingSaved": "Embedding 设置已保存。",
    "settings.embeddingSaveError": "无法保存 Embedding 设置。",
    "settings.embeddingTestError": "无法测试 Embedding 模型。",
    "settings.embeddingDimensions": "维",
    "settings.embeddingTokens": "tokens",
    "settings.semanticCoverage": "索引覆盖率",
    "settings.semanticActiveModel": "当前生效模型",
    "settings.refreshSemanticStatus": "刷新语义索引状态",
    "settings.semanticStatus.unconfigured": "未配置",
    "settings.semanticStatus.validating": "连接验证中",
    "settings.semanticStatus.backfilling": "回填中",
    "settings.semanticStatus.ready": "已就绪",
    "settings.semanticStatus.degraded": "异常",
